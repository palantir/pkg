...
// structCodec serves types that implement MarshalJSONTo, UnmarshalJSONFrom, and
// Equal directly, delegating to each. U is the pointer to T that implements
// UnmarshalJSONFrom. Equal is the type's own field-wise comparison.
