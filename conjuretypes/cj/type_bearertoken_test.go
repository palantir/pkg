...
func TestBearerToken(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			Test: typeTestCase[bearertoken.Token]{Codec: cj.BearerToken[bearertoken.Token](), JSON: "\"fo=o\"", SkipTestMarshal: true, ErrUnmarshalJSONFrom: "json: cannot unmarshal JSON string into Go bearertoken.Token after offset 6: invalid character for bearer token"},
		},
		{
			Name: "only_padding",
