...
// If reading the file fails, the LastCurrent() value will be unchanged. The error is present in v.Validation().
...
//
// LastCurrent() returns a map containing only successfully read files.
